...
export const CentralCard = tw.section`
    flex w-[900px] h-[600px] bg-white
`

export const LeftCard = tw.div`
    flex flex-col justify-between text-center bg-[#F4ECE6] w-[40%] h-[100%] shadow-[-10px_15px_10px_#00000038]
`
...
export const RightCard = tw.div`
    flex flex-col justify-between w-[58%] p-9
`